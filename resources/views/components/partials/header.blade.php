...
<header class="mx-auto flex h-16 max-w-[1200px] items-center justify-between px-5">
    <a href="{{ route('login.show') }}">
        <img class="cursor-pointer sm:h-auto sm:w-auto" src="{{ url('storage/images/company-logo.svg') }}"
            alt="company logo" />
    </a>
    ...
    <div class="hidden gap-3 md:!flex">
        <a href="{{ route('wish-list') }}" class="flex flex-col items-center justify-center cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        <a href="{{ route('account') }}" class="relative flex flex-col items-center justify-center cursor-pointer">
