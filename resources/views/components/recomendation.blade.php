    ...
    <section class="mx-auto grid max-w-[1200px] grid-cols-2 gap-3 px-5 pb-10 lg:grid-cols-4">
        ...
        <div class="flex flex-col">
            <div class="relative flex">
                <img class="" src="{{ url('storage/images/product-chair.png') }}" alt="sofa image" />
                <div
        ...
        <div class="flex flex-col">
            <div class="relative flex">
                <img class="" src="{{ url('storage/images/product-sofa.png') }}" alt="sofa image" />
        ...
        <div class="flex flex-col">
            <div class="relative flex">
                <img class="" src=" {{ url('storage/images/kitchen.png') }}" alt="kitchen image" />
                <div
                    class="absolute flex h-full w-full items-center justify-center gap-3 opacity-0 duration-150 hover:opacity-100">
                    <a href="product-overview.html">
                        <span
        ...
        <div class="flex flex-col">
            <div class="relative flex">
                <img class="" src="{{ url('storage/images/living-room.png') }}" alt="living room image" />
                <div
                    class="absolute flex h-full w-full items-center justify-center gap-3 opacity-0 duration-150 hover:opacity-100">
                    <a href="product-overview.html">
                        <span
        ...
        <div class="flex flex-col">
            <div class="relative flex">
                <img class="" src="{{ url('storage/images/bedroom.png') }}" alt="Bedroom image" />
                <div
                    class="absolute flex h-full w-full items-center justify-center gap-3 opacity-0 duration-150 hover:opacity-100">
                    <a href="product-overview.html">
                        <span
        ...
        <div class="flex flex-col">
            <div class="relative flex">
                <img class="" src="{{ url('storage/images/header-bg.jpeg') }}" alt="living room image" />
                <div
                    class="absolute flex h-full w-full items-center justify-center gap-3 opacity-0 duration-150 hover:opacity-100">
                    <a href="product-overview.html">
                        <span
        ...
        <div class="flex flex-col">
            <div class="relative flex">
                <img class="" src="{{ url('storage/images/outdoors.png') }}" alt="Outdoors image" />
                <div
                    class="absolute flex h-full w-full items-center justify-center gap-3 opacity-0 duration-150 hover:opacity-100">
                    <a href="product-overview.html">
                        <span
        ...
        <div class="flex flex-col">
            <div class="relative flex">
                <img class="" src="{{ url('storage/images/product-bigsofa.png') }}" alt="sofa image" />
                <div
                    class="absolute flex h-full w-full items-center justify-center gap-3 opacity-0 duration-150 hover:opacity-100">
                    <a href="product-overview.html">
                        <span
