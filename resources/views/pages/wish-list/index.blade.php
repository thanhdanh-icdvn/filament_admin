        ...
        <section class="hidden w-full max-w-[1200px] grid-cols-1 gap-8 px-5 pb-10 md:grid">
            ...
            <div class="flex w-full flex-row h-44 items-center justify-between border py-5 px-4">
                <div class="flex w-full items-center gap-4">
                    <img width="100px" class="object-cover" src="{{ url('storage/images/kitchen.png') }}"
                        alt="Kitchen image" />
            ...
            <div class="flex w-full h-44 flex-row items-center justify-between border py-5 px-4">
                <div class="flex w-full items-center gap-4">
                    <img width="100px" class="object-cover" src="{{ url('storage/images/bedroom.png') }}"
                        alt="Bedroom image" />
            ...
            <div class="flex w-full h-44 flex-row items-center justify-between border py-5 px-4">
                <div class="flex w-full items-center gap-4">
                    <img width="100px" class="object-cover" src="{{ url('storage/images/living-room.png') }}"
                        alt="Sofa image" />
            ...
            <div class="flex w-full h-44 flex-row items-center justify-between border py-5 px-4">
                <div class="flex w-full items-center gap-4">
                    <img width="100px" class="object-cover" src="{{ url('storage/images/product-chair.png') }}"
                        alt="Chair image" />
